...
EGG_DIR = SPLUNK_HOME + "/etc/apps/bugsense_ta/bin/"
...
SCHEME = """<scheme>
    ...
    <description>Poll data from the Bugsense REST API</description>
    ...
    <endpoint>
        <args>    
            <arg name="name">
                <title>Bugsense REST API endpoint name</title>
                <description>Name of this Bugsense REST API endpoint</description>
            </arg>
                   
            <arg name="bugsense_api_endpoint_base_url">
                <title>Bugsense REST API Base URL</title>
                <description>Bugsense REST API Base URL</description>
                <required_on_edit>true</required_on_edit>
                <required_on_create>true</required_on_create>
            </arg>

            <arg name="bugsense_auth_token">
                <title>Bugsense Authentication Token</title>
                <description>Bugsense Authentication Token</description>
                <required_on_edit>true</required_on_edit>
                <required_on_create>true</required_on_create>
            </arg>

            <arg name="bugsense_api_endpoint_path">
                <title>Bugsense REST API Endpoint Path</title>
                <description>Bugsense REST API Endpoint Path</description>
                <required_on_edit>true</required_on_edit>
                <required_on_create>true</required_on_create>
            </arg>

            <arg name="bugsense_project_id">
                <title>Bugsense Project ID</title>
                <description>Bugsense Project ID</description>
                <required_on_edit>true</required_on_edit>
                <required_on_create>true</required_on_create>
            </arg>
...
def do_run():
    ...
    endpoint=config.get("bugsense_api_endpoint_base_url")+"/"+config.get("bugsense_project_id")+"/"+config.get("bugsense_api_endpoint_path")
    ...
    http_header_propertys["X-BugSense-Auth-Token"]=config.get("bugsense_auth_token")
